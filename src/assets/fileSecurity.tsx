...
const FileSecurityIcon = ({
    ...
    >
        ...
        />
        <path
            d="M16.5 13C15.074 13 14.15 13.909 13.058 14.24C12.614 14.374 12.392 14.442 12.302 14.537C12.212 14.632 12.186 14.77 12.133 15.047C11.57 18.016 12.801 20.76 15.738 21.827C16.053 21.943 16.211 22 16.501 22C16.791 22 16.948 21.943 17.264 21.828C20.2 20.76 21.43 18.016 20.867 15.048C20.814 14.77 20.787 14.631 20.698 14.537C20.609 14.443 20.386 14.374 19.942 14.24C18.849 13.909 17.925 13 16.5 13Z"
            stroke="currentColor"
            strokeWidth={1.5}
            strokeLinecap="round"
            strokeLinejoin="round"
